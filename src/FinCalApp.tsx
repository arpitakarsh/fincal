...
import HeadlineSIP from '@/features/calculator/components/HeadlineSIP';
import ScenarioCards from '@/features/calculator/components/ScenarioCards';
import NLGoalInput from '@/features/ai/components/NLGoalInput';
import InsightParagraph from '@/features/ai/components/InsightParagraph';
import GoalValidator from '@/features/ai/components/GoalValidator';
import SensitivityHeatTable from '@/shared/components/charts/SensitivityHeatTable';
import AreaChart from '@/shared/components/charts/AreaChart';
import GlidePath from '@/shared/components/charts/GlidePath';
import StackedBarChart from '@/shared/components/charts/StackedBarChart';
import DonutChart from '@/shared/components/charts/DonutChart';
import HeroSection from '@/shared/components/layout/HeroSection';
import CostOfDelayCard from '@/features/calculator/components/CostOfDelayCard';
import GoalRealityIndicator from '@/features/calculator/components/GoalRealityIndicator';
import TaxationBanner from '@/shared/components/layout/TaxationBanner';
import ReverseCalculator from '@/features/calculator/components/ReverseCalculator';
import GoalComparison from '@/features/calculator/components/GoalComparison';
import ExportPdfButton from '@/shared/components/ui/ExportPdfButton';
import Header from '@/shared/components/layout/Header';
import GoalSelector from '@/features/goals/components/GoalSelector';
import GoalInputForm from '@/features/goals/components/GoalInputForm';
import RiskProfileSelector from '@/features/goals/components/RiskProfileSelector';
import SliderInput from '@/features/goals/components/SliderInput';
import QuickPresets from '@/features/goals/components/QuickPresets';
import StepUpToggle from '@/features/goals/components/StepUpToggle';
import LumpsumToggle from '@/features/goals/components/LumpsumToggle';
import GlowMenu from '@/shared/components/ui/GlowMenu';
...
export default function FinCalApp() {
  ...
  const {
    s, setS, set, setLock, onGoalChange, onProfileChange, onScenarioSelect, onRetSlider,
    hardErrors, softWarnings, hasErrors, results, scenarios, sensitivity, yearByYear
  } = useCalculator();
