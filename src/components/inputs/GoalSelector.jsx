      ...
      {GOAL_TYPES.map((goal) => {
        ...
        return (
          <motion.button
            ...
            className={`relative flex flex-col items-center justify-center p-5 rounded-[16px] border transition-all duration-200 focus:outline-none ${isSelected ? 'bg-blue-50/50' : 'bg-slate-50 hover:bg-white hover:border-[#224c87]'}`}
            style={{
